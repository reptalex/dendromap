...
#' @examples
get_lineage_par <- function(basal_ix,p_thresh=1,rc_relations.=rc_relations,rc_table.=rc_table,row.tree.=row.tree,
  ...
  lineage <- assemble_lineage(rc_tbl,rcm,rct,row.tree)
